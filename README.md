...
Supabase-prosjekt: `ivolv-bordtennis` (ref `boragvnduwxbnitxdxuu`, region `eu-central-1`).
...
- Innlogging med magic link (Supabase Auth)
- Selvregistrering av spillerprofil
...
Appen blir tilgjengelig på `https://<bruker>.github.io/<repo-navn>/`.
